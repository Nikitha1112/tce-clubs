...
<div class="container mt-4">
    ...
    <form action="<?php echo e(route('clubs.update', $club->id)); ?>" method="POST" enctype="multipart/form-data" class="bg-white p-4 rounded shadow-sm">
        <?php echo csrf_field(); ?>
            ...
            <div class="col-sm-9" id="student-fields">
                ...
                <?php $__currentLoopData = $club->studentCoordinators; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="input-group mb-2">
                        ...
                        <input type="file" name="student_photos[]" value="<?php echo e($student->photo); ?>" class="form-control">
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelproj1\resources\views/clubs/edit.blade.php ENDPATH**/ ?>